...
= 1.0.19 =
* Removed generic SQL injection check that caused conflicts with third-party hidden fields.
* Added a Merchant integration Checklist to help merchants verify their configuration before going live.
